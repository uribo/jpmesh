# Getting help with jpmesh

Thanks for using jpmesh. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/jpmesh/issues) to make sure the 
